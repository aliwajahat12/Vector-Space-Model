...
# Main Driver
# Contains UI, takes input from the user, pre processes the files and return the query results
...
class Ui_MainWindow(object):
    ...
    # Call to PreProcessing function
    def preProcess(self):
    ...
    # Call to query function and display the result
    def makeQuery(self):
